    ...
    <div class="container-fluid bg-white p-0">
        ...
        <div class="container-fluid header bg-white py-5">
            ...
            <div class="wow fadeIn" data-wow-delay="0.5s">
                <div class="container2 bg-transparent py-5">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 px-5 mt-lg-5">
                    <h1 class="mb-4 text-primary py-0">Tomat Segar</h1>
                    <h5 class="mb-1 text-dark">
                       ...
                       Harga Per(kg): 11000
                        <br><br>
                    <div><a href="" class="btn btn-secondary px-3 d-none d-lg-flex">Hubungi Petani</a>
                    </div>
                </div>
                <div class="col-md-6 animated fadeIn">
                    <div class="owl-carousel header-carousel">
                        <div class="img-fluid">
                            <img class="img-fluid" src="img/Tomat Segar.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
