                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="terlaris.html" class="dropdown-item active">Terlaris</a>
        ...
        <div class="container-fluid header bg-white p-5">
            ...
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Produk Terlaris</h1> 
                </div>
                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            ...
                            <div class="col-12 text-center">
                                <a class="btn btn-primary py-1 px-5" href="">Lebih Banyak Produk</a>
                            </div>
                        </div>
                    </div>
                </div>
